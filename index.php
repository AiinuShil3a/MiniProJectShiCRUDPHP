...
<body>
  ...
  <section id="Home" class="d-flex align-items-center">
    <div class="container position-relative" data-aos="fade-up" data-aos-delay="500">
      <h1>Welcome to Shil3aiinu</h1>
      <h2>Created by Supphalak M.</h2>
  ...
  <main id="main">
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-6 order-1 order-lg-2" data-aos="fade-left">
            <img src="assets/img/Img_about.jpg" class="img-fluid" alt="">
          </div>
          <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content" data-aos="fade-right">
            <h3>WEBSITE TEST CRUD FOR YOU</h3>
            <p class="fst-italic">
              Learn about these principles on this website. We've put it all together in one place.
            </p>
            <ul>
              <li><i class="bi bi-check-circle"></i>C - Created</li>
              <li><i class="bi bi-check-circle"></i>R - Reads</li>
              <li><i class="bi bi-check-circle"></i>U - Update</li>
              <li><i class="bi bi-check-circle"></i>D - Deleated</li>
            </ul>
            <p>
              You'll learn. These are things that I have specifically designed to try. It is not allowed to be published or commercialized. This website is provided by Supphalak M.
            </p>
          </div>
        </div>
      ...
      <div class="container" data-aos="zoom-in">
        ...
        <div class="row d-flex align-items-center">
          ...
          <div class="col-lg-2 col-md-4 col-6">
            <img src="assets/img/clients/client-1html.png" class="img-fluid" alt="" width="1000">
          </div>

          <div class="col-lg-2 col-md-4 col-6">
            <img src="assets/img/clients/client-2cs.png" class="img-fluid" alt="">
          </div>

          <div class="col-lg-2 col-md-4 col-6">
            <img src="assets/img/clients/client-3boot.png" class="img-fluid" alt="">
          </div>

          <div class="col-lg-2 col-md-4 col-6">
            <img src="assets/img/clients/client-4js.png" class="img-fluid" alt="">
          </div>

          <div class="col-lg-2 col-md-4 col-6">
            <img src="assets/img/clients/client-5php.png" class="img-fluid" alt="">
          </div>

          <div class="col-lg-2 col-md-4 col-6">
            <img src="assets/img/clients/client-6sql.png" class="img-fluid" alt="">
          </div>
    ...
    <section id="portfolio" class="portfolio">
      <div class="container">
        ...
        <?php
        include "controller/controller_view_recoment.php";
        ?>
